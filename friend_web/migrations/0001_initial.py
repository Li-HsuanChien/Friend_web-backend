    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('headshot', models.ImageField(default='static/img/headshots/default.png', null=True, upload_to='static/img/headshots/')),
                ('created_time', models.DateTimeField(auto_now_add=True)),
                ('updated_time', models.DateTimeField(auto_now=True)),
                ('gender', models.CharField(choices=[('M', 'Cis Gender Male'), ('F', 'Cis Gender Female'), ('N', 'Non Binary'), ('NA', 'Prefer Not To Say')])),
